...
cursor.execute('INSERT INTO Понедельник (номерпары, название_пары, учитель, кабинет) VALUES (?, ?, ?, ?)', ('4', 'Информационные технологии', 'Грибова', '615' ))
cursor.execute('INSERT INTO Понедельник (номерпары, название_пары, учитель, кабинет) VALUES (?, ?, ?, ?)', ('5', 'Основы баз данных', 'Шнейдр', '612' ))
...
cursor.execute('INSERT INTO Вторник (номерпары, название_пары, учитель, кабинет) VALUES (?, ?, ?, ?)', ('5', 'Основы баз данных', 'Шнейдр', '612' ))
...
cursor.execute('INSERT INTO Среда (номерпары, название_пары, учитель, кабинет) VALUES (?, ?, ?, ?)', ('4', 'Английский', 'Власова', '512' ))
...
cursor.execute('INSERT INTO Четверг (номерпары, название_пары, учитель, кабинет) VALUES (?, ?, ?, ?)', ('2', 'Основы баз данных', 'Шнейдр', '612' ))
...
cursor.execute('INSERT INTO Четверг (номерпары, название_пары, учитель, кабинет) VALUES (?, ?, ?, ?)', ('5', 'История', 'Римка', '628' ))
...
cursor.execute('INSERT INTO Пятница (номерпары, название_пары, учитель, кабинет) VALUES (?, ?, ?, ?)', ('7', 'Информационные технологии', 'Грибова', '615' ))
